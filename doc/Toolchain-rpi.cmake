...
elseif(RASPBERRY_VERSION VERSION_GREATER 2)
        set(CMAKE_C_FLAGS "-march=armv7-a -mfloat-abi=hard -mfpu=neon-vfpv4 ${COMMON_FLAGS}" CACHE STRING "Flags for Raspberry PI 3")
        set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS}" CACHE STRING "Flags for Raspberry PI 3")
elseif(RASPBERRY_VERSION VERSION_GREATER 1)
        set(CMAKE_C_FLAGS "-march=armv7-a -mfloat-abi=hard -mfpu=neon-vfpv4 ${COMMON_FLAGS}" CACHE STRING "Flags for Raspberry PI 2")
        set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS}" CACHE STRING "Flags for Raspberry PI 2")
else()
        set(CMAKE_C_FLAGS "-march=armv6 -mfloat-abi=hard -mfpu=vfp ${COMMON_FLAGS}" CACHE STRING "Flags for Raspberry PI 1 B+ Zero")
