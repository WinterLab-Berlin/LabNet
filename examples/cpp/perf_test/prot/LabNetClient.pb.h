...
constexpr ClientMessageType ClientMessageType_MAX = UART_INIT_DIGITAL_OUT;
...
inline void StartDigitalOutLoop::_internal_set_loop_name(const std::string& value) {
  ...
  loop_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void StartDigitalOutLoop::set_loop_name(const char* value) {
  ...
  loop_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:LabNetProt.Client.StartDigitalOutLoop.loop_name)
}
inline void StartDigitalOutLoop::set_loop_name(const char* value,
    size_t size) {
  
  loop_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* StartDigitalOutLoop::_internal_mutable_loop_name() {
  ...
  return loop_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
